...
class AppColor {
  static Map<int, Color> color = {
    50: Color.fromRGBO(130, 250, 142, .1),
    100: Color.fromRGBO(130, 250, 142, .2),
    200: Color.fromRGBO(130, 250, 142, .3),
    300: Color.fromRGBO(130, 250, 142, .4),
    400: Color.fromRGBO(130, 250, 142, .5),
    500: Color.fromRGBO(130, 250, 142, .6),
    600: Color.fromRGBO(130, 250, 142, .7),
    700: Color.fromRGBO(130, 250, 142, .8),
    800: Color.fromRGBO(130, 250, 142, .9),
    900: Color.fromRGBO(130, 250, 142, 1),
  };
  static MaterialColor mainBackground = MaterialColor(0xff82fa8e, color);
